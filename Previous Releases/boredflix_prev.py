#Almost finished version of boredflix, needs an external torrent streamer such as webtorrent ("https://webtorrent.io/"). 
#This version has the fastest response time of all the versions created, and is the most customisable due to the freedom of streaming source.
